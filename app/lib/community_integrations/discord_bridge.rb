...
module DiscordBridge
  ...
  def self.post_to_discord_general(username, content, chat_channel_id, message_id)
    ...
    body = { username: "#{username} (Forum)", content: discord_content, avatar_url: "https://forum.christitus.com/user_avatar/forum.christitus.com/#{username}/144/8_2.png" }.to_json
